  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        title: Container(
          child: Text('TO DO LIST', style: TextStyle(color: Colors.purple.shade900, fontWeight: FontWeight.w800, fontSize: 25),),
        ),
        actions: [
          Container(
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Container(
                            padding: EdgeInsets.all(10),
                            child: Text('Adicionar outra tarefa',style: TextStyle(color: Colors.deepPurple.shade300),),
                          )
                        ],
                      )
                    ],
